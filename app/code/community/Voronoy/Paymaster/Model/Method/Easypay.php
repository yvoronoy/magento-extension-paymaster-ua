 ...
 */
class Voronoy_Paymaster_Model_Method_Easypay extends Voronoy_Paymaster_Model_Method_Abstract
{
    protected $_code = 'paymaster_easypay';
    protected $_paymentSystemId = 12;
