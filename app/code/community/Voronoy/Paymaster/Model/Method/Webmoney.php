 ...
 */
class Voronoy_Paymaster_Model_Method_Webmoney extends Voronoy_Paymaster_Model_Method_Abstract
{
    protected $_code = 'paymaster_webmoney';
    protected $_paymentSystemId = 1;
