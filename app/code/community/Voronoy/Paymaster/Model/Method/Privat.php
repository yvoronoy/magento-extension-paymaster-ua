 ...
 */
class Voronoy_Paymaster_Model_Method_Privat extends Voronoy_Paymaster_Model_Method_Abstract
{
    protected $_code = 'paymaster_privat';
    protected $_paymentSystemId = 20;
