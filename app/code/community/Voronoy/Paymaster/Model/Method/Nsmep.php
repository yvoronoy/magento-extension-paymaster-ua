 ...
 */
class Voronoy_Paymaster_Model_Method_Nsmep extends Voronoy_Paymaster_Model_Method_Abstract
{
    protected $_code = 'paymaster_nsmep';
    protected $_paymentSystemId = 15;
