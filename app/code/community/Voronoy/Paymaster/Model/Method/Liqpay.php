 ...
 */
class Voronoy_Paymaster_Model_Method_Liqpay extends Voronoy_Paymaster_Model_Method_Abstract
{
    protected $_code = 'paymaster_liqpay';
    protected $_paymentSystemId = 19;
