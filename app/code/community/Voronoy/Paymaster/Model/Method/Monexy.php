 ...
 */
class Voronoy_Paymaster_Model_Method_Monexy extends Voronoy_Paymaster_Model_Method_Abstract
{
    protected $_code = 'paymaster_monexy';
    protected $_paymentSystemId = 6;
